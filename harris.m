...
%   2016 Elena Mihalas - extensions to average colour local to corners
%   final descriptor
...
greyimg = im(:,:,1)*0.30 + im(:,:,2)*0.59 + im(:,:,3)*0.11;
...
if subpixel
    ...
    for i=1:size(c_coord,1)     % I consider all top "n" corners
        ...
        for j=1:3
            ...
            Z1 = im(c_row-1:1:c_row+1,c_col_left-1:1:c_col_left+1,j)*X*Y;
            Z2 = im(c_row-1:1:c_row+1,c_col-1:1:c_col+1,j)*X*Y;
            Z3 = im(c_row-1:1:c_row+1,c_col_right-1:1:c_col_right+1,j)*X*Y;
